...
<div class="col1"><!--Start Bottom web content-->
    	...
    	<div class="header">
            ...
            <table cellpadding="0" cellspacing="0" height="230" id="table"> 
				...
				<?php 
				$getVotes = mysqli_query($connect, "SELECT songfile,songpoints FROM tblsongs WHERE songpoints >=1 ORDER BY songpoints DESC LIMIT 6") or die (mysqli_error($connect));
